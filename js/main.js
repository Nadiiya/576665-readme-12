            ...
            var i = t.querySelector(".tabs__list").querySelectorAll(".tabs__item")
                ...
                if (!n) {
                    ...
                    for (var e = 0; e < i.length; e++) {
                        var r = i[e];
                        t && r.classList.contains("tabs__item--active") && (t = !0,
                            c = e),
                            s(r, e)
                    }
                }
                ...
                if (t !== c) {
                    if (i[c].classList.remove("tabs__item--active"),
                        ...
                        i[t].parentNode.parentNode.querySelector(".filters__button--active").classList.remove("filters__button--active"),
                            i[t].classList.add("filters__button--active");
                    if (i[t].classList.contains("messages__contacts-tab"))
                        i[t].parentNode.parentNode.querySelector(".messages__contacts-tab--active").classList.remove("messages__contacts-tab--active"),
